...
function fromCache(request) {
	const cacheRequestFailed = new Response("No conntection to server and the requested page isn't available. Please return to the previous page if possible. (or connect to the internet).", {"status" : 408, "headers" : {"Content-Type" : "text/plain"}});
